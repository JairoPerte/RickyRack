...
public class CambiarImgPerfil2 extends Application{
	...
	// Confirmar (botón en el abajo en el medio) -> cambiarImagen(con,valor);
	...
	private final static int MALE_2=4;
	    ...
	    public void cambiarImagen(int id) {
	      ...
	      //Añadimos espacio entre imágenes
	        ...
	        try {
	        	ImageView female1 = new ImageView(new Image(new FileInputStream("C:/Users/monic/git/Proyecto-Programacion/media/img/interfaz/defaultfemale1.png")));
	        	ImageView female2 = new ImageView(new Image(new FileInputStream("C:/Users/monic/git/Proyecto-Programacion/media/img/interfaz/defaultfemale2.png")));
	        	ImageView male1 = new ImageView(new Image(new FileInputStream("C:/Users/monic/git/Proyecto-Programacion/media/img/interfaz/defaultmale1.png")));
	        	ImageView male2 = new ImageView(new Image(new FileInputStream("C:/Users/monic/git/Proyecto-Programacion/media/img/interfaz/defaultmale2.png")));
